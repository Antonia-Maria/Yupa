...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row" align="left">
        <div class="col-md-12">
            ...
            <div class="card"><br>
                <h3>Products
                    <a href="<?php echo e(url('admin/products/create')); ?>" class="btn btn-primary btn-sm text-white float-end"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Yupa\resources\views/admin/products/index.blade.php ENDPATH**/ ?>